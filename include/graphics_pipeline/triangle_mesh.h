...
public:
	...
	void DrawPoints(PlanarPinholeCamera *camera, Framebuffer *framebuffer, unsigned int color, int size);
	void DrawWireFrame(PlanarPinholeCamera *camera, Framebuffer *framebuffer, unsigned int color);
};