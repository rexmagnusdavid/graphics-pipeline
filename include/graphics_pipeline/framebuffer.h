...
public:
	...
	void Draw2DSegment(Vector3 point_0, Vector3 point_1, Vector3 color_0, Vector3 color_1);

	void Draw3DPoint(PlanarPinholeCamera* camera, Vector3 point, int size, unsigned int color);
	void Draw3DSegment(PlanarPinholeCamera* camera, Vector3 point_0, Vector3 point_1, unsigned int color);
	void Draw3DSegment(PlanarPinholeCamera* camera, Vector3 point_0, Vector3 point_1, Vector3 color_0, Vector3 color_1);
};